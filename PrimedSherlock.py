...
#%%
    ...
    if str(config.get('Features', "Run_Cas-off")) == 'Yes':
        ...
        if(Primed_RPA != "Yes"):
            ...
            MaxBackground = data[data.columns[9]] #6
    ...
    for primer in New_FPrimer:
        ...
        n = n + 1
    ##############################################################################
    #TODO: Make sure copyright is okay with PrimedRPA
...
#%%
    ...
    if pathtest.endswith("Cas-OnInput") == True:
        print("[Primed Sherlock] Halfway Mark")
    else:
        try:
            path = path + '\Cas-OnInput'
            os.chdir(path)
                    ...
                    for value in crRNA:
                        if Unique == value:
                            ...
                            if current_score == 0:
                                ...
                                usable_crRNA = 1
                            if current_score <=3 and current_score >= 1: #SET USER VARIABLE #FIXME (was <=5 and > 1)
                                usable_crRNA = 1
